    ...
    return (
      <div className='landingPage'>
        ...
        <div id='app-info' aria-live='polite'>
          ...
          <p aria-label='app information'>
            To test out the site please create a new account. To test the live game feature you will have to log in as a different
            user via a mobile device or separate internet browser (ie: Safari, Chrome, Firefox etc.) This will give you the ability to play against yourself
            in the two separate browsers. Alternatively, you may invite a friend and
